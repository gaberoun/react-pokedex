# Instruction
## As a user, I should be able to see a list of pokemon
### Acceptance criteria
- Display pokemons from the pokeapi.
- On initial load of the page, user will see 20 pokemons and a Load More button.
- When the Load More button is clicked another 20 pokemons will be loaded on the page. And so on.
